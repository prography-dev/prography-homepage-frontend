...
const Culture = () => {
  return (
    <div className={styles.CultureWrapper}>
      <p className="sf_heading_1">Culture</p>
      <div className={styles.CultureContainer}>
        <div className={styles.CultureLeftSection}>
          ...
          <div className={styles.CultureDescription}>
            ...
            <p className="sf_heading_3">Membership Training</p>
        ...
        <div className={styles.CultureSection}>
          <div className={styles.CultureDescription}>
            ...
            <p className="sf_heading_3">Orientation</p>
            <p className={styles.SectionDetail}>
        ...
        <div className={styles.CultureLeftSection}>
          ...
          <div className={styles.CultureDescription}>
            ...
            <p className="sf_heading_3">Hakathon</p>
            <p className={styles.SectionDetail}>
        ...
        <div className={styles.CultureSection}>
          <div className={styles.CultureDescription}>
            ...
            <p className="sf_heading_3">Prography Day</p>
            <p className={styles.SectionDetail}>
              프로그라피만의 특별한 이벤트로, <br />
        ...
        <div className={styles.CultureLeftSection}>
          ...
          <div className={styles.CultureDescription}>
            ...
            <p className="sf_heading_3">Demo Day</p>
            <p className={styles.SectionDetail}>
              지금까지 열심히 개발한 프로덕트를 공유하고, <br />
        ...
        <div className={styles.CultureSection}>
          <div className={styles.CultureDescription}>
            ...
            <p className="sf_heading_3">StartUp Day</p>
            <p className={styles.SectionDetail}>
              영향력있는 스타트업과 만남의 장을 가지며, <br />
              새로운 기회와 네트워크를 발굴합니다.
            </p>
          </div>
        ...
        <div className={styles.CultureLeftSection}>
          ...
          <div className={styles.CultureDescription}>
            ...
            <p className="sf_heading_3">Prography Conference</p>
            <p className={styles.SectionDetail}>
